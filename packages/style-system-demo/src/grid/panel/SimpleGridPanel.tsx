...
const SimpleGridPanel: React.FC = () => (
  <Box>
    <p>This sample shows a <code>Grid</code> with three rows, each containing <code>Panel</code>s.
      For tablet screens (or larger) each panel gets its share from the row width. The size
      can be used to get a bigger share.<br/>
    </p>
    <Grid spacing="0.5rem">
      <Row>

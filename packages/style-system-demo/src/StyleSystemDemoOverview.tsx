...
const StyleSystemDemoOverview: React.FC = () => {
  return (
    <>
      <p>
        The Indoqa Style-System provides provides a typed theming system and comes with
        the fundamental building block <code>Box</code>, <code>Flex</code>, <code>Grid</code>
        and layouts (coming soon).
      </p>
      <Grid spacing="1.5rem" mt={3}>
        <ColRow>
          <Col size={[12, 12, 6]}>
            <p><code>Box</code> and <code>Flex</code></p>
            <BlueFlexBox>
